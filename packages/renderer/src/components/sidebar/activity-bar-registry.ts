...
export const ACTIVITY_BAR_REGISTRY: ActivityBarItemDef[] = [
  ...
  { id: 'outline', labelKey: 'activityBar.outline', shortcut: 'Ctrl+E', defaultVisible: true, defaultOrder: 5 },
  { id: 'properties', labelKey: 'activityBar.properties', defaultVisible: true, defaultOrder: 6 },
  { id: 'tags', labelKey: 'activityBar.tags', defaultVisible: true, defaultOrder: 7 },
  { id: 'calendar', labelKey: 'activityBar.calendar', defaultVisible: false, defaultOrder: 8 },
  { id: 'kanban', labelKey: 'activityBar.kanban', defaultVisible: false, defaultOrder: 9 },
  { id: 'daily-note', labelKey: 'activityBar.dailyNote', defaultVisible: false, defaultOrder: 10 },
]
