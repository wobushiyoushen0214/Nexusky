...
export const ACTIVITY_BAR_REGISTRY: ActivityBarItemDef[] = [
  { id: 'overview', labelKey: 'activityBar.overview', defaultVisible: true, defaultOrder: 0 },
  { id: 'files', labelKey: 'activityBar.files', shortcut: 'Ctrl+B', defaultVisible: true, defaultOrder: 1, pinned: true },
  { id: 'search', labelKey: 'activityBar.search', shortcut: 'Ctrl+Shift+F', defaultVisible: true, defaultOrder: 2, pinned: true },
  { id: 'chat', labelKey: 'activityBar.chat', shortcut: 'Ctrl+L', defaultVisible: true, defaultOrder: 3 },
