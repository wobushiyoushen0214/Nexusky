...
- `BasesView` toolbar search, inline property edit fields, toolbar actions, tag/sort filters, column picker actions, column checkboxes, tag lens controls, note title actions, inline edit targets, property pills, inline edit hints, main content scrolling, and main empty/loading state now use shared `Input`, `Button`, `Select`, `Checkbox`, `Badge`, `Tooltip`, `ScrollArea`, `Empty`, and `Spinner`.
...
| Bases controls | `components/bases/BasesView.tsx` | `Input`, `Button`, `Select`, `Checkbox`, `Badge`, `Tooltip`, `ScrollArea`, `Empty`, `Spinner` | Done for toolbar search, inline property edit fields, toolbar actions, tag/sort filters, column picker actions, column checkboxes, tag lens controls, note title actions, inline double-click edit targets, property pills, inline edit hints, main content scrolling, and main empty/loading state. |
