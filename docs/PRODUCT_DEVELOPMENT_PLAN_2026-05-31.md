...
后续风险：A2 性能基础已覆盖缓存键、同步结果缓存、扫描状态协议、后端分组扫描、watcher/indexer 文件级 query-cache 失效、UI partial results 和性能日志；A3.1/A3.2 已完成 Provider 测试 UI 与无 AI 路径说明收口，但 A3.3 更完整错误归因文案仍待做。
