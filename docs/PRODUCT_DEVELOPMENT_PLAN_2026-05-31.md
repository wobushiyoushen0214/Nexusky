...
后续风险：A2 性能基础已覆盖缓存键、同步结果缓存、扫描状态协议、后端分组扫描、watcher/indexer 文件级 query-cache 失效、UI partial results 和性能日志；A3.1-A3.3 已完成 Provider 测试 UI、无 AI 路径说明和错误归因文案收口，A3.4 首次来源问答引导与 A3.5 当前语言传入 AI prompt 仍待做。
